    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        <div className={`${darkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} border rounded-2xl p-6`}>
          ...
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>We calculate the 14-period RSI for the top 1000 cryptocurrencies to identify oversold and overbought conditions.</p>
        </div>
        <div className={`${darkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} border rounded-2xl p-6`}>
          <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center mb-4"><svg className="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div>
          <h3 className="text-xl font-bold mb-2">Real-Time Data</h3>
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Data is refreshed every minute from CoinGecko's API for accurate analysis.</p>
        </div>
        <div className={`${darkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} border rounded-2xl p-6`}>
          <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center mb-4"><svg className="w-6 h-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" /></svg></div>
          <h3 className="text-xl font-bold mb-2">Personal Watchlist</h3>
          <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Sign in with Google to save tickers to your personal watchlist.</p>
        </div>
      </div>
      <div className={`${darkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} border rounded-2xl p-8 mb-8`}>
        ...
        <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>RSI = 100 - (100 / (1 + RS)), where RS = Average Gain / Average Loss over 14 periods.</p>
        <div className="grid md:grid-cols-2 gap-4">
          <div className={`${darkMode ? 'bg-red-500/10 border-red-500/20' : 'bg-red-50 border-red-200'} border rounded-xl p-4`}><h3 className="font-bold text-red-500 mb-2">Oversold (RSI &lt; 30)</h3><p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>May indicate undervaluation and buying opportunities.</p></div>
          <div className={`${darkMode ? 'bg-green-500/10 border-green-500/20' : 'bg-green-50 border-green-200'} border rounded-xl p-4`}><h3 className="font-bold text-green-500 mb-2">Overbought (RSI &gt; 70)</h3><p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>May indicate overvaluation. Consider taking profits.</p></div>
        </div>
      </div>
